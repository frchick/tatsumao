...
*/
/*
/// Defines the title font used for [MyListTile] descendants of a [ListTileTheme].
///
...
enum ListTileStyle {
  /// Use a title font that's appropriate for a [MyListTile] in a list.
  list,

  /// Use a title font that's appropriate for a [MyListTile] that appears in a [Drawer].
  drawer,
}
*/
/*
/// Where to place the control in widgets that use [MyListTile] to position a
/// control next to a label.
///
/// See also:
///
///  * [CheckboxListTile], which combines a [MyListTile] with a [Checkbox].
///  * [RadioListTile], which combines a [MyListTile] with a [Radio] button.
///  * [SwitchListTile], which combines a [MyListTile] with a [Switch].
///  * [ExpansionTile], which combines a [MyListTile] with a button that expands
...
/// between the [MyListTile] and its [Material] ancestor, then the
...
///   child: Material(
///     child: MyListTile(
///       title: const Text('MyListTile with red background'),
...
/// [MyListTile]s in [Card]s.
///
/// ![Different variations of MyListTile](https://flutter.github.io/assets-for-api-docs/assets/material/list_tile.png)
///
/// ```dart
/// ListView(
///   children: const <Widget>[
///     Card(child: MyListTile(title: Text('One-line MyListTile'))),
///     Card(
///       child: MyListTile(
///         leading: FlutterLogo(),
...
///     Card(
///       child: MyListTile(
///         title: Text('One-line dense MyListTile'),
///         dense: true,
///       ),
///     ),
///     Card(
...
///         title: Text('Two-line MyListTile'),
...
///         title: Text('Three-line MyListTile'),
///         subtitle: Text(
...
/// {@tool snippet}
///
/// To use a [MyListTile] within a [Row], it needs to be wrapped in an
/// [Expanded] widget. [MyListTile] requires fixed width constraints,
...
///
/// For this reason, a one-line MyListTile allows the height of [leading]
/// and [trailing] widgets to be constrained by the height of the MyListTile.
...
/// {@tool snippet}
///
/// Here is an example of a one-line, non-[dense] MyListTile with a
...
/// MyListTile, adjust the vertical padding to 8.0.
///
/// ```dart
/// MyListTile(
...
/// {@end-tool}
///
/// ## The MyListTile layout isn't exactly what I want
///
/// If the way MyListTile pads and positions its elements isn't quite what
...
/// See also:
///
///  * [ListTileTheme], which defines visual properties for [MyListTile]s.
///  * [ListView], which can display an arbitrary number of [MyListTile]s
///    in a scrolling list.
///  * [CircleAvatar], which shows an icon representing a person and is often
///    used as the [leading] element of a MyListTile.
///  * [Card], which can be used with [Column] to show a few [MyListTile]s.
///  * [Divider], which can be used to separate [MyListTile]s.
///  * [MyListTile.divideTiles], a utility for inserting [Divider]s in between [MyListTile]s.
///  * [CheckboxListTile], [RadioListTile], and [SwitchListTile], widgets
///    that combine [MyListTile] with other controls.
...
class MyListTile extends StatelessWidget {
  ...
  /// {@template flutter.material.MyListTile.shape}
  ...
  ///
  /// Insets a [MyListTile]'s contents: its [leading], [title], [subtitle],
  ...
  /// {@template flutter.material.MyListTile.mouseCursor}
  ...
  /// {@template flutter.material.MyListTile.tileColor}
  /// Defines the background color of `MyListTile` when [selected] is false.
  ///
  ...
  /// Defines the background color of `MyListTile` when [selected] is true.
  ///
  /// When the value if null, the `selectedTileColor` is set to [ListTileTheme.selectedTileColor]
  /// if it's not null and to [Colors.transparent] if it's null.
  final Color? selectedTileColor;

  /// {@template flutter.material.MyListTile.enableFeedback}
  ...
  /// The minimum width allocated for the [MyListTile.leading] widget.
  ///
  ...
  {
    if(_tapDetails != null){
      onTap?.call(_tapDetails!);
    }
  }

  void _onLongPressFunc()
  {
    if(_tapDetails != null){
      onLongPress?.call(_tapDetails!);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: enabled ? _onTapFunc : null,
      onLongPress: enabled ? _onLongPressFunc : null,
...
class _MyListTile extends RenderObjectWidget with SlottedMultiChildRenderObjectWidgetMixin<_ListTileSlot> {
  const _MyListTile({
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _MyRenderListTile createRenderObject(BuildContext context) {
    return _MyRenderListTile(
      isThreeLine: isThreeLine,
      isDense: isDense,
  ...
  @override
  void updateRenderObject(BuildContext context, _MyRenderListTile renderObject) {
    renderObject
      ..isThreeLine = isThreeLine
      ..isDense = isDense
      ..visualDensity = visualDensity
...
class _MyRenderListTile extends RenderBox with SlottedContainerRenderObjectMixin<_ListTileSlot> {
  _MyRenderListTile({
  ...
  void performLayout() {
    ...
    assert(
      ...
      'or consider replacing MyListTile with a custom widget '
      '(see https://api.flutter.dev/flutter/material/MyListTile-class.html#material.MyListTile.4)',
    );
    assert(
