...
class MyDragMarker {
  // NOTE: 派生クラスでメンバー変数を代入するため、次のメソッドのfinal を外した
  // void Function(DragStartDetails details, LatLng latLng)? onDragStart;
  // void Function(DragUpdateDetails details, LatLng latLng)? onDragUpdate;
  // NOTE: onDragEndの返り値は以前LatLngだったが，voidになっている
  // void Function(DragEndDetails details, LatLng latLng)? onDragEnd;
  // void Function(LatLng latLng)? onTap;
  // void Function(LatLng latLng)? onLongPress;
  ...
  /* final */ void Function(DragStartDetails details, LatLng latLng, int index)? onDragStart;

  /// This callback gets called when the DragMarker gets dragged around
  /* final */ void Function(DragUpdateDetails details, LatLng latLng, int index)? onDragUpdate;

  /// This callback gets called when the DragMarker stopps to get dragged
  /* final */ LatLng Function(DragEndDetails details, LatLng latLng, int index)? onDragEnd;

  /// This callback gets called when the DragMarker starts to get dragged with
  /// the [useLongPress] option enabled
  void Function(LongPressStartDetails details, LatLng latLng)?
      onLongDragStart;
  ...
  /* final */ void Function(LatLng latLng, int index)? onTap;

  /// This callback gets called when the DragMarkerWiidget gets long pressed
  /* final */ void Function(LatLng latLng, int index)? onLongPress;
